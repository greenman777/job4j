...
Виртуальная машина Java исполняет байт-код Java, предварительно созданный из исходного текста Java-программы компилятором Java (javac). JVM может также использоваться для выполнения программ, написанных на других языках программирования. Исходный код на ряде языков может быть скомпилирован в байт-код Java, который затем может выполниться с помощью JVM. 
JVM является абстракцией фактической машины. JVM создает предсказуемую среду для запускаемых внутри нее программ. 
Внутри работающей JVM происходит важный процесс -  Сборка мусора, который непрерывно определяет и устраняет неиспользуемую память в программах.
Глобально JVM состоит из трех частей: спецификация, реализация и экземпляр.
...
Переменная — поименованная или адресуемая иным способом область памяти, которую можно использовать для доступа к данным. Переменная простыми словами — это хранилище данных. Сюда можно положить какое-то значение. Переменные в Java делятся на два типа: примитивные и ссылочные. Примитивные типы у себя внутри хранят значение, а ссылочные – ссылку на объект.
Для оптимальной работы приложения JVM делит память на область стека (stack) и область кучи (heap).
Примитивные значения или ссылки на объекты хранятся в стеке. 
...
В Java все типы данных можно разделить на две группы: примитивные и ссылочные типы. Отличаются они по способу хранения в памяти.
Примитивных типов в Java всего 8 штук, а ссылочных бесконечное множество. 
...
Создание и запуск jar архива:
jar -cmf manifest.mf my-app.jar  -C bin
java -jar my-app.jar 
...
``` 
Начиная с Java 12 можно писать так:
```
int count = 2;
